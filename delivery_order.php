...
$orderType = "Delivery"; // Specify the type of order
            ...
            <div id="items-container" class="grid grid-cols-3 gap-6">
                ...
                if ($items) {
                    foreach ($items as $item) {
                        ...
                        echo "<form action='delivery_order.php' method='POST' class='mt-4'>";
                        ...
                        echo "<button type='submit' name='add_to_cart' class='w-full bg-blue-500 hover:bg-blue-600 text-white mt-3 py-2 rounded'>Add to Cart</button>";
                        echo "</form>";
                        echo "</div>";
                    }
                } else {
